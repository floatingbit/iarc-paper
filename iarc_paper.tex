...
\caption{General architecture of the Beohawk control system. \todo{This needs to be updated but serves as a placeholder}.} 
\label{fig:architecture}
\end{figure}

\subsection{Yearly Milestones}
\todo{Not sure what's supposed to go in here?}
